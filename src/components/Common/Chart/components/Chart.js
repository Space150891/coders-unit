...
export default class Chart extends React.Component {
  ...
  // //@TODO REALLY determine if it should update
  ...
  buildDataTableFromProps() {
    ...
    if (this.props.dateFormat) {
      const formatter = new window.google.visualization.DateFormat(
        this.props.dateFormat.options
      );
      formatter.format(dataTable, this.props.dateFormat.column);
    }
    return dataTable;
  }
...
Chart.propTypes = {
  ...
  dateFormat:   PropTypes.shape({
    ...
    options: PropTypes.shape({
      ...
      tiemzone:    PropTypes.string   // eslint-disable-line react/no-unused-prop-types
    }),
  }),
